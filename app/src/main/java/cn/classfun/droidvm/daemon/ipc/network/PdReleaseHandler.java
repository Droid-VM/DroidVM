...
public final class PdReleaseHandler extends RequestHandler {
    @NonNull
    @Override
    public String getName() {
        return "network_pd_release";
    }
    ...
    public void handle(@NonNull ClientRequest request) throws Exception {
        ...
        if (!inst.releasePd(vlanId))
            throw new RequestException("failed to release PD delegation");
    }
}
