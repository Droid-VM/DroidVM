...
public final class RemoveAddressHandler extends RequestHandler {
    @NonNull
    @Override
    public String getName() {
        return "network_remove_address";
    }
    ...
    public void handle(@NonNull ClientRequest request) throws Exception {
        ...
        if (!inst.removeAddress(network))
            throw new RequestException("failed to remove address");
    }
}
